...
public class StudentDAOImpl implements StudentDAO{
    ...
    @Override
    @Transactional
    public void deleteByLastName(String givenLastName) {
     var query =     entityManager.createQuery("DELETE FROM Student WHERE lastName=:param");
    query.setParameter("param", givenLastName);
    query.executeUpdate();
    }
}
